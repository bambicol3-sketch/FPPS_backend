...
from app.domains.google_auth.adapter.inbound.api.google_auth_router import router as google_auth_router
...
from app.domains.ddakjubu.adapter.inbound.api.ddakjubu_router import router as ddakjubu_router
from app.domains.ddakjubu2.adapter.inbound.api.ddakjubu2_router import router as ddakjubu2_router
...
from app.domains.study_room.adapter.inbound.api.study_room_router import router as study_room_router
from app.domains.mse_market_analysis.adapter.inbound.api.mse_market_analysis_router import (
    router as mse_market_analysis_router,
)
from app.domains.mse_sectors.adapter.inbound.api.mse_sectors_router import (
    router as mse_sectors_router,
)
from app.domains.mse_credit.adapter.inbound.api.mse_credit_router import (
    router as mse_credit_router,
)
...
from app.domains.template_rag.adapter.inbound.api.template_rag_router import router as template_rag_router
from app.domains.semiconductor.adapter.inbound.api.semiconductor_router import router as semiconductor_router
from app.domains.fab_agent.adapter.inbound.api.fab_agent_router import router as fab_agent_router
from app.domains.frontier_agent.adapter.inbound.api.frontier_agent_router import router as frontier_agent_router
from app.domains.global_portfolio.adapter.inbound.api.global_portfolio_router import router as global_portfolio_router
...
api_v1_router.include_router(study_room_router)   # STUDY ROOM: /api/v1/study-room/...
api_v1_router.include_router(mse_market_analysis_router)  # MSE MARKET ANALYSIS: /api/v1/mse-market-analysis/...
api_v1_router.include_router(mse_sectors_router)          # MSE SECTORS: /api/v1/mse-sectors/...
api_v1_router.include_router(mse_credit_router)           # MSE CREDIT: /api/v1/mse-credit/...
...
api_v1_router.include_router(google_auth_router)  # GOOGLE AUTH: /api/v1/google-authentication/...
...
api_v1_router.include_router(ddakjubu_router)    # DDAKJUBU: /api/v1/ddakjubu/...
api_v1_router.include_router(ddakjubu2_router)   # DDAKJUBU2: /api/v1/ddakjubu2/...
api_v1_router.include_router(macro_router)       # MACRO: /api/v1/macro/...
api_v1_router.include_router(template_rag_router, prefix="/rag")          # /api/v1/rag/...
api_v1_router.include_router(template_rag_router, prefix="/template-rag") # alias: /api/v1/template-rag/...
api_v1_router.include_router(template_rag_router, prefix="/ppt")          # alias: /api/v1/ppt/...
api_v1_router.include_router(semiconductor_router)  # SEMICONDUCTOR: /api/v1/semiconductor/...
api_v1_router.include_router(global_portfolio_router)  # GLOBAL PORTFOLIO: /api/v1/global-portfolio/...
api_v1_router.include_router(fab_agent_router)  # FAB AGENT: /api/v1/fab-agent/...
api_v1_router.include_router(frontier_agent_router)  # FRONTIER AGENT: /api/v1/frontier-agent/...
