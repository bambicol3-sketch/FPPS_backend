...
from app.domains.pdf_to_ppt.adapter.inbound.api.pdf_to_ppt_router import router as pdf_to_ppt_router
...
api_v1_router.include_router(pdf_to_ppt_router)  # PDF TO PPT: /api/v1/pdf-to-ppt/...
